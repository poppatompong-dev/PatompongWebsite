...
const testimonials = [
  ...
  {
    name: "คุณนภา ว.",
    role: "ผู้จัดการสำนักงาน · บริษัทเอกชน",
    content:
      "วางระบบเน็ตเวิร์คให้สำนักงาน 3 ชั้น เน็ตลื่นไหลทุกจุด ไม่มีหลุด พนักงาน 40 คนใช้พร้อมกันได้สบาย ตรงเวลา ราคาตรงที่ตกลง ไม่มีค่าใช้จ่ายแอบแฝง",
    rating: 5,
    project: "ระบบเครือข่าย LAN/WiFi",
  },
  {
    name: "คุณวิทยา จ.",
