        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <a href="#home" className="flex items-center gap-3 sm:gap-4 group">
            <div className="relative w-16 h-16 sm:w-20 sm:h-20 shrink-0">
              <Image src="/logo-main.png" alt="Patompong Tech Consultant Logo" fill className={`object-contain group-hover:scale-110 transition-all duration-300 drop-shadow-lg mix-blend-multiply ${scrolled ? '' : 'mix-blend-screen brightness-200 drop-shadow-[0_0_12px_rgba(217,119,6,0.4)]'}`} sizes="(max-width: 640px) 64px, 80px" priority />
            </div>
