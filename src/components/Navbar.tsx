        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <a href="#home" className="flex items-center gap-2 sm:gap-3 group">
            <div className="relative w-10 h-10 sm:w-12 sm:h-12 shrink-0">
              <Image src="/logo-icon.png" alt="Patompong Tech Consultant Logo" fill className={`object-contain group-hover:scale-110 transition-all duration-300 ${scrolled ? 'drop-shadow-sm' : 'drop-shadow-[0_0_12px_rgba(217,119,6,0.4)]'}`} sizes="48px" priority />
            </div>
            <div className="flex flex-col">
              <span className={`text-base sm:text-lg font-heading font-bold tracking-tight leading-tight transition-colors ${scrolled ? 'text-ink-800' : 'text-cream-50'}`}>Patompong</span>
              <span className="text-[9px] font-code text-gold-400 leading-tight tracking-[0.2em] uppercase">Tech Consultant</span>
            </div>
          </a>
